  ...
  namespace rosmsg
  {
    namespace visualization_msgs
    {
      class InteractiveMarkerControl : public yarp::os::idl::WirePortable
      {
        ...
        InteractiveMarkerControl() : name( "" ), orientation(), orientation_mode( 0 ), interaction_mode( 0 ), always_visible( false ), markers(), independent_marker_orientation( false ), description( "" )
        {
        }
