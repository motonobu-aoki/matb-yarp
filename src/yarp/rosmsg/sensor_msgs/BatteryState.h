  ...
  namespace rosmsg
  {
    namespace sensor_msgs
    {
      class BatteryState : public yarp::os::idl::WirePortable
      {
        ...
        BatteryState() : header(), voltage( 0.0f ), current( 0.0f ), charge( 0.0f ), capacity( 0.0f ), design_capacity( 0.0f ), percentage( 0.0f ), power_supply_status( 0 ), power_supply_health( 0 ), power_supply_technology( 0 ), present( false ), cell_voltage(), location( "" ), serial_number( "" )
        {
        }
