  ...
  namespace rosmsg
  {
    namespace sensor_msgs
    {
      class LaserScan : public yarp::os::idl::WirePortable
      {
        ...
        LaserScan() : header(), angle_min( 0.0f ), angle_max( 0.0f ), angle_increment( 0.0f ), time_increment( 0.0f ), scan_time( 0.0f ), range_min( 0.0f ), range_max( 0.0f ), ranges(), intensities()
        {
        }
